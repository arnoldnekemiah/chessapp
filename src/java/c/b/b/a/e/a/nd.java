...
extends ee<ve> {
    ...
    public nd(od od2, Context context, zzvs zzvs2, String string, v4 v42) {
        this.f = od2;
        this.b = context;
        this.c = zzvs2;
        this.d = string;
    ...
    public final /* synthetic */ Object a() {
        od.a((Context)this.b, (String)"banner");
        return new c();
    }

    public final /* synthetic */ Object a(gf gf2) {
        return gf2.a(new b<Context>(this.b), this.c, this.d, this.e, 204204000);
    }

    public final /* synthetic */ Object b() {
        return this.f.a.a(this.b, this.c, this.d, this.e, 1);
    }
}
